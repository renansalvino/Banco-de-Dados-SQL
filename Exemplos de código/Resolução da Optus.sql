...
--Selecionar os lbuns lançados na mesma data --
...
--Selecionar Albuns e artistas e ordenar por data de lançamento (Do mais antigo para o mais recente)

SELECT * FROM Albuns ORDER BY DataLancamento asc;

-- Com JOIN
SELECT Artista.Nome as ;

--Desafio Realizar INNER JOIN EM 3 TABELAS -- 
